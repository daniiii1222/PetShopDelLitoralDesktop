...
namespace PetShopDelLitoral
{
    ...
    public partial class FrmPersonas : Form
    {
        ...
        private void FrmPersonas_Load(object sender, EventArgs e)
        {
            ...
            // 1. Configuramos y cargamos los usuarios por defecto al arrancar la pantalla
            ConfigurarGridUsuarios();
            CargarUsuarios();

            // 2. Aseguramos que el botón derecho comience indicando el estado correcto
            btVerInactivos.Text = "Ver Inactivos";

            // 3. Aplicamos el filtro inicial para que muestre todo o los activos según prefieras
            FiltrarGrilla();
        }
            ...
            if (tipoSeleccionado == "Usuario")
            {
                try
                {
                    Persona objPersona = new Persona()
                    {
                        ...
                        idPersona = idPersonaSeleccionada, // Asegurate de tener esta variable global o sacarla de la celda oculta
